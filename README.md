...
alias gseth='source ~/user_scripts/git/git_reset_HEAD.zsh'              # 直接重製到前第n個提交
alias gk5='source ~/user_scripts/git/git_keep_5new_commits.zsh'              # 保留前五個提交
alias gmota='source ~/user_scripts/git/git_remote_add.zsh'              # remote add 參數簡寫
